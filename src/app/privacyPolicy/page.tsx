...
const PrivacyPolicy = () => {
  ...
  gtag('config', 'G-QDZHVVJQG7');`}
      ...
      <Container sx={{ py: 4 }}>
        ...
        <p>Effective from: August 01, 2023</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Crishika, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Crishika.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Crishika, accessible from{' '}
              <a
                href="https://www.crishika.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.crishika.com
              </a>
            </p>
          </li>
          <li>
